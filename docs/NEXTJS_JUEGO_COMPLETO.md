...
1) Función para construir el mapa de cartas desde la respuesta de `GET /api/cartas`:
...
3) Ejemplo de uso en `onPartidaIniciada` dentro de `useGameWebSocket` (o en el handler de la página):
